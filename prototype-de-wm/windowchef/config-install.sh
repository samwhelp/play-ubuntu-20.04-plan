...
windowchef_config_install () {
	...
	echo "install -m 755 ./config/windowchef/default/windowchefrc $HOME/.config/windowchef/windowchefrc"
	install -m 755 "./config/windowchef/default/windowchefrc" "$HOME/.config/windowchef/windowchefrc"
	

	
	windowchef_put_toggledesktop_desktop_entry
	windowchef_put_exit_desktop_entry
}
...
windowchef_put_toggledesktop_desktop_entry () {
	...
	cp "./config/windowchef/asset/desktop-entry/windowchef-toggle-show-desktop.desktop" "$HOME/.local/share/applications/windowchef-toggle-show-desktop.desktop"
	echo "cp ./config/windowchef/asset/desktop-entry/windowchef-toggle-show-desktop.desktop $HOME/.local/share/applications/windowchef-toggle-show-desktop.desktop"
...
windowchef_put_exit_desktop_entry () {
	...
	cp "./config/windowchef/asset/desktop-entry/windowchef-exit.desktop" "$HOME/.local/share/applications/windowchef-exit.desktop"
	echo "cp ./config/windowchef/asset/desktop-entry/windowchef-exit.desktop $HOME/.local/share/applications/windowchef-exit.desktop"
...
sxhkd_config_install () {
	...
	echo "install -m 644 ./config/windowchef/default/sxhkdrc $HOME/.config/windowchef/sxhkdrc"
	install -m 644 "./config/windowchef/default/sxhkdrc" "$HOME/.config/windowchef/sxhkdrc"
...
tint2_config_install () {
	...
	mkdir -p "$HOME/.config/windowchef/tint2"
	echo "mkdir -p $HOME/.config/windowchef/tint2"

	cp "./config/tint2/tint2rc" "$HOME/.config/windowchef/tint2/tint2rc"
	echo "cp ./config/tint2/tint2rc $HOME/.config/windowchef/tint2/tint2rc"
...
compton_config_install () {
	...
	mkdir -p "$HOME/.config/windowchef/compton"
	echo "mkdir -p $HOME/.config/windowchef/compton"

	#cp "/usr/share/doc/compton/examples/compton.sample.conf" "$HOME/.config/windowchef/compton/compton.conf"
	#echo "cp /usr/share/doc/compton/examples/compton.sample.conf $HOME/.config/windowchef/compton/compton.conf"

	cp "./config/compton/compton.conf" "$HOME/.config/windowchef/compton/compton.conf"
	echo "cp ./config/compton/compton.conf $HOME/.config/windowchef/compton/compton.conf"
