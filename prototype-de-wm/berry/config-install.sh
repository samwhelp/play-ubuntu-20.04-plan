...
berry_config_install () {
	...
	echo "install -m 755 ./config/berry/default/autostart $HOME/.config/berry/autostart"
	install -m 755 "./config/berry/default/autostart" "$HOME/.config/berry/autostart"
	

	
	berry_put_toggledesktop_desktop_entry
	berry_put_exit_desktop_entry
}
...
berry_put_toggledesktop_desktop_entry () {
	...
	cp "./config/berry/asset/desktop-entry/berry-toggle-show-desktop.desktop" "$HOME/.local/share/applications/berry-toggle-show-desktop.desktop"
	echo "cp ./config/berry/asset/desktop-entry/berry-toggle-show-desktop.desktop $HOME/.local/share/applications/berry-toggle-show-desktop.desktop"
...
berry_put_exit_desktop_entry () {
	...
	cp "./config/berry/asset/desktop-entry/berry-exit.desktop" "$HOME/.local/share/applications/berry-exit.desktop"
	echo "cp ./config/berry/asset/desktop-entry/berry-exit.desktop $HOME/.local/share/applications/berry-exit.desktop"
...
sxhkd_config_install () {
	...
	echo "install -m 644 ./config/berry/default/sxhkdrc $HOME/.config/berry/sxhkdrc"
	install -m 644 "./config/berry/default/sxhkdrc" "$HOME/.config/berry/sxhkdrc"
...
tint2_config_install () {
	...
	mkdir -p "$HOME/.config/berry/tint2"
	echo "mkdir -p $HOME/.config/berry/tint2"

	cp "./config/tint2/tint2rc" "$HOME/.config/berry/tint2/tint2rc"
	echo "cp ./config/tint2/tint2rc $HOME/.config/berry/tint2/tint2rc"
...
compton_config_install () {
	...
	mkdir -p "$HOME/.config/berry/compton"
	echo "mkdir -p $HOME/.config/berry/compton"

	#cp "/usr/share/doc/compton/examples/compton.sample.conf" "$HOME/.config/berry/compton/compton.conf"
	#echo "cp /usr/share/doc/compton/examples/compton.sample.conf $HOME/.config/berry/compton/compton.conf"

	cp "./config/compton/compton.conf" "$HOME/.config/berry/compton/compton.conf"
	echo "cp ./config/compton/compton.conf $HOME/.config/berry/compton/compton.conf"
