...
xsession_config_install () {
	...
	## install
	sudo install -m 644 "./config/xsession/cwm-session.desktop" "/usr/share/xsessions/cwm-session.desktop"
	sudo install -m 755 "./config/xsession/cwm-session.sh" "/usr/local/bin/cwm-session.sh"

	## check
	ls -l "/usr/share/xsessions/cwm-session.desktop"
	ls -l "/usr/local/bin/cwm-session.sh"
...
cwm_config_install () {
	...
	echo "install -m 755 ./config/cwm/kb1/cwmrc $HOME/.cwmrc"
	install -m 755 "./config/cwm/kb1/cwmrc" "$HOME/.cwmrc"
	

	
	#cwm_put_toggledesktop_desktop_entry
	cwm_put_exit_desktop_entry
}
...
cwm_put_toggledesktop_desktop_entry () {
	...
	cp "./config/cwm/asset/desktop-entry/cwm-toggle-show-desktop.desktop" "$HOME/.local/share/applications/cwm-toggle-show-desktop.desktop"
	echo "cp ./config/cwm/asset/desktop-entry/cwm-toggle-show-desktop.desktop $HOME/.local/share/applications/cwm-toggle-show-desktop.desktop"
...
cwm_put_exit_desktop_entry () {
	...
	cp "./config/xsession/cwm-exit.desktop" "$HOME/.local/share/applications/cwm-exit.desktop"
	echo "cp ./config/xsession/cwm-exit.desktop $HOME/.local/share/applications/cwm-exit.desktop"
...
sxhkd_config_install () {
	...
	echo "mkdir -p $HOME/.config/cwm/sxhkd"
	mkdir -p "$HOME/.config/cwm/sxhkd"


	echo "install -m 644 ./config/cwm/kb1/sxhkdrc $HOME/.config/cwm/sxhkd/sxhkdrc"
	install -m 644 "./config/cwm/kb1/sxhkdrc" "$HOME/.config/cwm/sxhkd/sxhkdrc"
...
tint2_config_install () {
	...
	mkdir -p "$HOME/.config/cwm/tint2"
	echo "mkdir -p $HOME/.config/cwm/tint2"

	cp "./config/tint2/tint2rc" "$HOME/.config/cwm/tint2/tint2rc"
	echo "cp ./config/tint2/tint2rc $HOME/.config/cwm/tint2/tint2rc"
...
compton_config_install () {
	...
	mkdir -p "$HOME/.config/cwm/compton"
	echo "mkdir -p $HOME/.config/cwm/compton"

	#cp "/usr/share/doc/compton/examples/compton.sample.conf" "$HOME/.config/cwm/compton/compton.conf"
	#echo "cp /usr/share/doc/compton/examples/compton.sample.conf $HOME/.config/cwm/compton/compton.conf"

	cp "./config/compton/compton.conf" "$HOME/.config/cwm/compton/compton.conf"
	echo "cp ./config/compton/compton.conf $HOME/.config/cwm/compton/compton.conf"
