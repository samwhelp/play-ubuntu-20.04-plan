...
marco_set_keybindings_toggle_maximized () {
	...
	#gsettings set org.mate.Marco.window-keybindings maximize 'disabled'
	#gsettings set org.mate.Marco.window-keybindings maximize-horizontally 'disabled'
	#gsettings set org.mate.Marco.window-keybindings maximize-vertically 'disabled'	
	
	gsettings set org.mate.Marco.window-keybindings maximize-horizontally '<Super><Shift>w'
	gsettings set org.mate.Marco.window-keybindings maximize-vertically '<Super><Control>w'
...
marco_set_keybindings_about_workspace () {
	...
	#gsettings set org.mate.Marco.global-keybindings rename-workspace 'disabled'
	
	gsettings set org.mate.Marco.workspace-names name-1 'Term'
	gsettings set org.mate.Marco.workspace-names name-2 'Edit'
	gsettings set org.mate.Marco.workspace-names name-3 'Web'
	gsettings set org.mate.Marco.workspace-names name-4 'File'
	...
	gsettings set org.mate.Marco.window-keybindings move-to-workspace-3 "'<Super>3'"
	gsettings set org.mate.Marco.window-keybindings move-to-workspace-4 "'<Super>4'"
	gsettings set org.mate.Marco.window-keybindings move-to-workspace-5 "'<Super>5'"
	gsettings set org.mate.Marco.window-keybindings move-to-workspace-6 "'<Super>6'"
...
sxhkd_config_install () {
	...
	mkdir -p "$HOME/.config/marco-session/sxhkd"
	echo "mkdir -p $HOME/.config/marco-session/sxhkd"

	cp "./config/sxhkd/sxhkdrc" "$HOME/.config/marco-session/sxhkd/sxhkdrc"
	echo "cp ./config/sxhkd/sxhkdrc $HOME/.config/marco-session/sxhkd/sxhkdrc"
