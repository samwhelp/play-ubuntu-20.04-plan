...
mutter_config_install_setting () {
	...
	mutter_set_wallpaper

	mutter_set_theme

	mutter_set_keybindings_show_desktop

	mutter_set_keybindings_switch_windows

	mutter_set_keybindings_win_close

	mutter_set_keybindings_toggle_fullscreen

	mutter_set_keybindings_toggle_maximized

	mutter_set_keybindings_minimize

	mutter_set_keybindings_begin_move

	mutter_set_keybindings_begin_resize

	mutter_set_keybindings_toggle_above

	mutter_set_keybindings_toggle_shaded

	mutter_set_keybindings_raise_or_lower

	mutter_set_keybindings_toggle_tiled

	mutter_set_edge_tiling

	mutter_set_keybindings_about_workspace
	
	mutter_set_titlebar_action
...
sxhkd_config_install () {
	...
	mkdir -p "$HOME/.config/mutter-session/sxhkd"
	echo "mkdir -p $HOME/.config/mutter-session/sxhkd"

	cp "./config/sxhkd/sxhkdrc" "$HOME/.config/mutter-session/sxhkd/sxhkdrc"
	echo "cp ./config/sxhkd/sxhkdrc $HOME/.config/mutter-session/sxhkd/sxhkdrc"
