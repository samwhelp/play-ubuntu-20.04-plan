...
__main__ () {
	...
	## $ which demo-gnome-session.sh
	## /usr/bin/demo-gnome-session.sh

	## run demo-gnome-session.sh
	#DISPLAY=:100 /usr/bin/demo-gnome-session.sh
	DISPLAY=:100 XDG_CURRENT_DESKTOP=Demo demo-gnome-session.sh
