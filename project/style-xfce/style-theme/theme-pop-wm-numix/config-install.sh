...
theme_config_install_ui_theme () {
	...
	## <property name="ThemeName" type="string" value="Pop-dark"/>

	echo "xfconf-query -c 'xsettings' -p '/Net/ThemeName' -s 'Pop-dark'"
	xfconf-query -c 'xsettings' -p '/Net/ThemeName' -s 'Pop-dark'
...
theme_config_install_icon_theme_pop () {

	## ~/.config/xfce4/xfconf/xfce-perchannel-xml/xsettings.xml
	## <property name="IconThemeName" type="string" value="Pop"/>

	echo "xfconf-query -c 'xsettings' -p '/Net/IconThemeName' -s 'Pop'"
